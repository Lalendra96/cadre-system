...
class Employee extends Model
{
    ...
    protected $casts = [
        ...
        'date_joined_public_service' => 'date',
        'date_joined_combined_service' => 'date',
        'date_joined_institution' => 'date',
    ...
    public function retirementProjects()
    {
        return $this->hasMany(
            RetirementProject::class,
            'employee_id'
        );
    }
    ...
    {
        return $this->hasMany(
            EmployeeServicePeriod::class,
            'employee_id'
        );
    }

    public function currentServicePeriod()
    {
        return $this->hasOne(
            EmployeeServicePeriod::class,
            'employee_id'
    ...
    public function getRetireDateAttribute(): ?\Carbon\Carbon
    {
        ...
        return $this->date_of_birth->addYears(
            $this->retirement_age ?? 60
        );
    }
    ...
    {
        $start = $this->date_joined_public_service
