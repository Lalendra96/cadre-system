        ...
        <div class="md-card__body">
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;margin-bottom:14px;">
                <div class="md-field">
                    ...
                    <input type="date" name="interdiction_date" class="md-field__input @error('interdiction_date') md-field--error @enderror" value="{{ old('interdiction_date') }}" required>
                    @error('interdiction_date')<div class="md-field__error">{{ $message }}</div>@enderror
                </div>
                <div class="md-field">
            ...
            <div class="md-field" style="margin-bottom:14px;">
                ...
                <input type="text" name="inquiry_reference_no" class="md-field__input @error('inquiry_reference_no') md-field--error @enderror" value="{{ old('inquiry_reference_no') }}" maxlength="100">
                @error('inquiry_reference_no')<div class="md-field__error">{{ $message }}</div>@enderror
            </div>
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;margin-bottom:14px;">
                <div class="md-field">
                    <label class="md-field__label">Reinstatement Date</label>
                    <input type="date" name="reinstatement_date" class="md-field__input @error('reinstatement_date') md-field--error @enderror" value="{{ old('reinstatement_date') }}">
                    @error('reinstatement_date')<div class="md-field__error">{{ $message }}</div>@enderror
                </div>
                <div class="md-field">
