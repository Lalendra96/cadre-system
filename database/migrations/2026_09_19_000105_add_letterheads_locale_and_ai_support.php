...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create(
            ...
            function (Blueprint $table): void {
                ...
                $table->string(
                    'institution_name',
                    180
                )->default('Teaching Hospital Peradeniya');

                $table->string('ministry_name', 180)->nullable();
                ...
                $table->boolean('show_national_emblem')->default(true);
        ...
        Schema::table(
            ...
            function (Blueprint $table): void {
                ...
                $table->string('recipient_address', 300)
                    ->nullable()
                ...
                $table->string('copy_type', 30)
                    ->default('original')
                    ->after('reference_no');

                $table->foreign('letterhead_id')
                    ->references('id')
                    ->on('service_letter_letterheads')
                    ->nullOnDelete();
        ...
        DB::table('service_letter_letterheads')->insert([
            'name' => "Director's Office — TH Peradeniya",
            'institution_name' => 'Teaching Hospital Peradeniya',
            'ministry_name' => 'Ministry of Health',
            'department_name' => 'Government of Sri Lanka',
            'address_line_1' => 'Peradeniya, Sri Lanka',
            'reference_prefix' => 'THP/',
            'signatory_designation' => 'Administrative Officer / Hospital Secretary',
            'show_national_emblem' => true,
            'is_default' => true,
            'is_active' => true,
            'created_by' => $adminId,
            'created_at' => now(),
    ...
    public function down(): void
    {
        Schema::table(
            'users',
            fn (Blueprint $table) => $table->dropColumn('locale')
        );
